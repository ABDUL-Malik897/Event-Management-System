...
const VerifyLoginOTP = () => {
    ...
    return (
        ...
        <div className="verify-otp-card">
            <div className="verify-otp-icon">✉️</div>
            <p className="verify-otp-badge">LOGIN VERIFICATION</p>
            <h1>Verify Login OTP</h1>
            <p className="verify-otp-description">
            We've sent a 6-digit verification code to
            </p>
            <p className="verify-otp-email">{email || "your email"}</p>
            ...
            <Link to="/login" className="verify-otp-back">
            ← Back to Login
            </Link>
        </div>
        </div>
